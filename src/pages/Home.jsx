  ...
  return (
    <div className='p-10'>
      ...
      <ul className='flex justify-between flex-wrap gap-5'>
        {isLoading ? 
        <li className='mx-auto mt-10'> <LoadingOutlined className='text-green-700' style={{fontSize:"60px"}} /> </li> 
        : products.length > 0 ? products.map(item => <ProductItem key={item.id} item={item} />) : <Empty className='inline-block mx-auto mt-[45px]' />}
      </ul>
